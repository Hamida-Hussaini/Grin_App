...
import com.example.grin.NonFoodFragment;
...
//public class NonFoodListingAdaptor extends RecyclerView.Adapter<NonFoodListingAdaptor.MyViewHolder> {
public class NonFoodListingAdaptor extends FirebaseRecyclerAdapter<ModalClassNonFoodListing,NonFoodListingAdaptor.MyViewHolder> {
    final FirebaseDatabase database = FirebaseDatabase.getInstance();
    Double longitude=null;Double latitude=null;
    DatabaseReference ref ;
    String userName ;
    String userImage;
    public NonFoodListingAdaptor(@NonNull FirebaseRecyclerOptions<ModalClassNonFoodListing> options) {

        super(options);
    }
    @Override
    protected void onBindViewHolder(final MyViewHolder holder, final int position, final ModalClassNonFoodListing model) {
    ...
    public void onDataRetrieved(String userName,String userImage,MyViewHolder holder,ModalClassNonFoodListing model,float distance) {
