...
import com.example.grin.MainContainer;
import com.example.grin.R;
import com.example.grin.Signup;
import com.example.grin.fragments.item_request;
...
public class NearLocationListingAdapter extends FirebaseRecyclerAdapter<ModalClassListing,NearLocationListingAdapter.MyViewHolder> {
    final FirebaseDatabase database = FirebaseDatabase.getInstance();
    Double longitude=null;Double latitude=null;
    DatabaseReference ref ;
    String userName ;
    String userImage;
    public NearLocationListingAdapter(@NonNull FirebaseRecyclerOptions<ModalClassListing> options) {

        super(options);
    }
    @Override
    protected void onBindViewHolder(final NearLocationListingAdapter.MyViewHolder holder, final int position, final ModalClassListing model) {
        try
        {
            getUserLocaton();
            getSettingData(holder,model);

            // Log.d("","getSettingDataAdapter: "+common.wantedListing+" "+common.sortBy+" "+common.distance);
    ...
    public void getSettingData(final NearLocationListingAdapter.MyViewHolder holder, final ModalClassListing model) {
            ...
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        String showAllList = snapshot.child("showAll").getValue(String.class);
                        Double distance= snapshot.child("distance").getValue(Double.class);
                        setData(wantListing,showAllList,sortBy,distance,holder,model);
                    } else {
    ...
    public void setData(String wantList, final String showAll, String sort, final Double dis, final NearLocationListingAdapter.MyViewHolder holder, final ModalClassListing model)
    {
    ...
    @Override
    public NearLocationListingAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.product_card_view, parent, false);
        return new NearLocationListingAdapter.MyViewHolder(view);
    }
    ...
    public void onDataRetrieved(final String userName, final String userImage, final NearLocationListingAdapter.MyViewHolder holder, final ModalClassListing model, float distance) {
        try {
