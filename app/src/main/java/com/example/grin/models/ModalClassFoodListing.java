...
public class ModalClassFoodListing {
    ...
    String userName;
    String wantedList;
    public ModalClassFoodListing(String itemName,String itamType, String itemUri, String lastDate, String listingDate, String status, String userId, Integer noViews, Double latitude, Double longitude,String wantedList) {
